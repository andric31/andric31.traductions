...
(function () {
  ...
  if (!window.CreatorFeature) {
    ...
    function getLinkIcon(type, label, url) {
      const key = creatorSlug(type || label || url || "website");
      const iconClass = "creatorLinkSvg";
      const wrap = (svg) => `<span class="creatorPageLinkIcon" aria-hidden="true">${svg}</span>`;
      ...
      const icons = {
        ...
        discord: wrap(svg("0 0 24 24", `<path d="M7.7 8.4c2.8-2 5.8-2 8.6 0 .5 1.1.9 2.2 1.2 3.4.4 1.4.6 2.8.7 4.2-1 .7-2 1.2-3.2 1.6l-.7-1.2c.5-.2 1-.4 1.4-.7-.3.2-.7.3-1 .4-2 .7-4 .7-5.9 0-.3-.1-.6-.2-1-.4.4.3.9.5 1.4.7l-.7 1.2c-1.1-.4-2.2-.9-3.2-1.6.1-1.4.4-2.8.7-4.2.3-1.2.7-2.3 1.2-3.4Zm2.8 6.2c.7 0 1.2-.6 1.2-1.4 0-.8-.6-1.4-1.2-1.4-.7 0-1.2.6-1.2 1.4 0 .8.5 1.4 1.2 1.4Zm3 0c.7 0 1.2-.6 1.2-1.4 0-.8-.6-1.4-1.2-1.4-.7 0-1.2.6-1.2 1.4 0 .8.5 1.4 1.2 1.4Z"/>`)),
        ...
        bluesky: wrap(svg("0 0 24 24", `<path d="M12 11.3C10.5 8.3 7.9 6 5 4.5c-.7-.4-1.5.1-1.5.9 0 2.5 1.1 5 3 6.8 1.3 1.3 2.8 2.1 4.5 2.5-1 .1-2 .4-2.9.9-1.7.9-2.9 2.5-3.3 4.3-.1.7.5 1.3 1.2 1.1 3-.7 5.6-2.5 7-5 1.4 2.5 4 4.3 7 5 .7.2 1.4-.4 1.2-1.1-.4-1.8-1.6-3.4-3.3-4.3-.9-.5-1.9-.8-2.9-.9 1.7-.4 3.2-1.2 4.5-2.5 1.9-1.8 3-4.3 3-6.8 0-.8-.8-1.3-1.5-.9C16.1 6 13.5 8.3 12 11.3Z"/>`)),
        vndb: wrap(svg("0 0 24 24", `<path d="M3 5h7.5L12 8.6 13.5 5H21l-6 14h-3L3 5Zm3.2 2.5 4.4 9.4 1.7-3.9-2.6-5.5H6.2Zm7.8 0-1.3 3 1.2 2.6 2.1-5.6H14Zm3.7 0-2.3 6.2 1.5 3.2 3-9.4h-2.2Z"/>`)),
        ...
        steam: wrap(svg("0 0 24 24", `<path d="M14.7 2.6a5.4 5.4 0 1 0 5.4 5.4 5.4 5.4 0 0 0-5.4-5.4Zm0 2.3a3.1 3.1 0 1 1-3.1 3.1 3.1 3.1 0 0 1 3.1-3.1Z"></path><path d="M9.7 12.8 6.5 11a3.8 3.8 0 1 0-.7 7.4 3.8 3.8 0 0 0 3.6-2.7l2.9-1.2 3.1-4.9-1.9-1.2-3.8 4.4-2 0Zm-3.9 3.3a1.6 1.6 0 1 1 0-3.1 1.6 1.6 0 0 1 0 3.1Z"></path>`)),
        patreon: wrap(svg("0 0 24 24", `<path d="M15.5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm-11 0h3v17h-3z"/>`)),
        ...
        f95: wrap(svg("0 0 24 24", `<path d="M4 5h14v2.5H6.8v3.1H17V13H6.8v6H4V5Zm17 0h-2.3v14H21V5Z"/>`)),
        f95zone: wrap(svg("0 0 24 24", `<path d="M4 5h14v2.5H6.8v3.1H17V13H6.8v6H4V5Zm17 0h-2.3v14H21V5Z"/>`)),
