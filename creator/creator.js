...
(function () {
  ...
  function getLinkIcon(type, label, url) {
    ...
    const icons = {
      ...
      steam: wrap(svg("0 0 24 24", `<path d="M12 2C6.48 2 2 6.48 2 12c0 4.23 2.63 7.84 6.35 9.3l-1.32-3.04a2.8 2.8 0 0 1-1.2-.45l-1.92-.78a1.06 1.06 0 0 1 .8-1.96l1.93.79a2.84 2.84 0 0 1 3.4-1.16l4.6-3.25c0-.08-.01-.16-.01-.25a4.44 4.44 0 1 1 4.44 4.44c-.39 0-.77-.05-1.13-.15l-3.28 4.67a2.85 2.85 0 0 1-5.45-.35A10.03 10.03 0 0 0 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2Zm5.48 4.17a2.77 2.77 0 1 0 0 5.54 2.77 2.77 0 0 0 0-5.54ZM8.28 15.63a1.67 1.67 0 1 0 0 3.34 1.67 1.67 0 0 0 0-3.34Z"/>`), "is-steam is-wide"),
      patreon: wrap(svg("0 0 24 24", `<path d="M15.5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm-11 0h3v17h-3z"/>`)),
