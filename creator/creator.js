...
(function () {
  ...
  function getLinkIcon(type, label, url) {
    ...
    const icons = {
      ...
      steam: wrap(svg("0 0 24 24", `<circle cx="17.35" cy="7.15" r="4.35" fill="none" stroke="currentColor" stroke-width="1.8"></circle><circle cx="17.35" cy="7.15" r="1.55"></circle><circle cx="7.85" cy="16.55" r="3.1" fill="none" stroke="currentColor" stroke-width="1.7"></circle><circle cx="7.85" cy="16.55" r="1.05"></circle><path d="M10.4 15.1 15.15 10.9" fill="none" stroke="currentColor" stroke-width="1.85" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5.1 15.1 3.85 14.6" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>`), "is-steam is-vwide"),
      patreon: wrap(svg("0 0 24 24", `<path d="M15.5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm-11 0h3v17h-3z"/>`)),
