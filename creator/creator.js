...
(function () {
  ...
  function getLinkIcon(type, label, url) {
    ...
    const icons = {
      ...
      steam: wrap(svg("0 0 24 24", `<circle cx="12" cy="12" r="9.1" fill="none" stroke="currentColor" stroke-width="1.7"></circle><circle cx="16.95" cy="7.85" r="3.55" fill="none" stroke="currentColor" stroke-width="1.65"></circle><circle cx="16.95" cy="7.85" r="1.22"></circle><circle cx="8.2" cy="15.95" r="2.45" fill="none" stroke="currentColor" stroke-width="1.6"></circle><circle cx="8.2" cy="15.95" r=".85"></circle><path d="M10.2 14.8 13.95 11.35" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5.75 14.9 4.6 14.45" fill="none" stroke="currentColor" stroke-width="1.65" stroke-linecap="round"></path>`), "is-steam is-vwide"),
      patreon: wrap(svg("0 0 24 24", `<path d="M15.5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm-11 0h3v17h-3z"/>`)),
      itch: wrap(svg("0 0 24 24", `<path d="M4 9.5c0-1.2 1-2.2 2.2-2.2.7 0 1.3.3 1.7.8.4-.5 1-.8 1.7-.8.8 0 1.5.4 1.9 1 .4-.6 1.1-1 1.9-1 .7 0 1.3.3 1.7.8.4-.5 1-.8 1.7-.8C19 7.3 20 8.3 20 9.5v4.3c0 1.3-1 2.3-2.3 2.3H6.3C5 16.1 4 15.1 4 13.8V9.5Zm3.2 1.2a1.3 1.3 0 1 0 0 2.7 1.3 1.3 0 0 0 0-2.7Zm9.6 0a1.3 1.3 0 1 0 0 2.7 1.3 1.3 0 0 0 0-2.7Z"/>`), "is-itch is-wide"),
      "itch-io": wrap(svg("0 0 24 24", `<path d="M4 9.5c0-1.2 1-2.2 2.2-2.2.7 0 1.3.3 1.7.8.4-.5 1-.8 1.7-.8.8 0 1.5.4 1.9 1 .4-.6 1.1-1 1.9-1 .7 0 1.3.3 1.7.8.4-.5 1-.8 1.7-.8C19 7.3 20 8.3 20 9.5v4.3c0 1.3-1 2.3-2.3 2.3H6.3C5 16.1 4 15.1 4 13.8V9.5Zm3.2 1.2a1.3 1.3 0 1 0 0 2.7 1.3 1.3 0 0 0 0-2.7Zm9.6 0a1.3 1.3 0 1 0 0 2.7 1.3 1.3 0 0 0 0-2.7Z"/>`), "is-itch is-wide"),
