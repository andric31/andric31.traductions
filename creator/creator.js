...
(function () {
  ...
  function getLinkIcon(type, label, url) {
    ...
    const icons = {
      ...
      bluesky: wrap(svg("3 3.5 18 17", `<path d="M12 11.4C10.4 8.8 8.2 6.6 5.8 5.1c-.8-.5-1.7.1-1.7 1 .1 2 .9 3.9 2.3 5.3 1.2 1.2 2.6 1.9 4.1 2.2-1.4.3-2.6 1-3.6 2.1-1 1.1-1.6 2.5-1.7 4-.1.8.7 1.4 1.5 1.1 2.4-.8 4.4-2.6 5.9-5 1.5 2.4 3.5 4.2 5.9 5 .8.3 1.6-.3 1.5-1.1-.1-1.5-.7-2.9-1.7-4-1-1.1-2.2-1.8-3.6-2.1 1.5-.3 2.9-1 4.1-2.2 1.4-1.4 2.2-3.3 2.3-5.3.1-.9-.9-1.5-1.7-1-2.4 1.5-4.6 3.7-6.2 6.3Z"/>`), "is-bluesky"),
      vndb: wrap(svg("0 0 24 24", `<rect x="3.5" y="4.5" width="17" height="15" rx="4" fill="none" stroke="currentColor" stroke-width="1.7"></rect><text x="12" y="15" text-anchor="middle" font-size="8.6" font-weight="900" font-family="Arial, sans-serif" fill="currentColor">VN</text>`), "is-vndb"),
