...
(function () {
  ...
  function getLinkIcon(type, label, url) {
    ...
    const icons = {
      ...
      steam: wrap(svg("0 0 24 24", `<circle cx="12" cy="12" r="9.8" fill="none" stroke="currentColor" stroke-width="2"></circle><circle cx="16.95" cy="7.85" r="3.45" fill="none" stroke="currentColor" stroke-width="1.6"></circle><circle cx="16.95" cy="7.85" r="1.18"></circle><circle cx="8.2" cy="15.95" r="2.35" fill="none" stroke="currentColor" stroke-width="1.55"></circle><circle cx="8.2" cy="15.95" r=".82"></circle><path d="M10.2 14.8 13.95 11.35" fill="none" stroke="currentColor" stroke-width="1.68" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5.75 14.9 4.6 14.45" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"></path>`), "is-steam is-vwide"),
      patreon: wrap(svg("0 0 24 24", `<path d="M15.5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm-11 0h3v17h-3z"/>`)),
