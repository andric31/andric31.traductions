...
(function () {
  ...
  function getLinkIcon(type, label, url) {
    ...
    const icons = {
      ...
      steam: wrap(svg("0 0 24 24", `<circle cx="17.4" cy="7.2" r="4.3" fill="none" stroke="currentColor" stroke-width="1.8"></circle><circle cx="17.4" cy="7.2" r="1.65"></circle><circle cx="8.25" cy="16.45" r="2.45" fill="none" stroke="currentColor" stroke-width="1.8"></circle><circle cx="8.25" cy="16.45" r=".9"></circle><path d="M10.35 15.25 15.1 12.05" fill="none" stroke="currentColor" stroke-width="1.85" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5.95 15.45 4.35 14.85" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>`), "is-steam is-vwide"),
      patreon: wrap(svg("0 0 24 24", `<path d="M15.5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm-11 0h3v17h-3z"/>`)),
