...
function cleanGame(raw) {
  ...
  return {
    ...
    date: cleanText(raw.date || raw.updatedAt || raw.last_update || raw.lastUpdate),
    cover,
    banner,
    image: cover || banner,
    ...
    source: raw.source && typeof raw.source === 'object' ? {
      ...
      name: cleanText(raw.source.name),
      post_id: cleanText(raw.source.post_id || raw.source.postId),
      url: cleanText(raw.source.url),
    } : null,
