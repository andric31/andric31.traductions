...
(() => {
  ...
  function applyViewerTheme(t) {
   ...
   function initHeaderMenuAndDisplayTools() {
     ...
     // ✅ bouton aide (page principale uniquement)
     if (!document.getElementById("helpBtn")) {
       const helpBtn = document.createElement("button");
       helpBtn.type = "button";
       helpBtn.id = "helpBtn";
       helpBtn.className = "help-btn";
       helpBtn.setAttribute("aria-label", "Aide : présentation du menu");
       helpBtn.innerHTML = `<span aria-hidden="true">❔</span>`;
       row.insertBefore(helpBtn, h1);

       // Modal / info-bulle
       if (!document.getElementById("helpModalBackdrop")) {
         ...
         backdrop.innerHTML = `
           <div class="help-modal" role="dialog" aria-modal="true" aria-labelledby="helpModalTitle">
             <div class="help-modal-head">
               <div>
                 <div class="help-modal-title" id="helpModalTitle">Présentation des différentes options du menu.</div>
                 <div class="help-modal-sub">Page principale (viewer)</div>
               </div>
               <button type="button" class="help-close" aria-label="Fermer">✕</button>
             </div>

             <div class="help-modal-body">
               <div class="help-section">
                 <div class="help-section-title">Barre du haut — Menu_barre_haut.png</div>
                 <div class="help-media">
                   <img src="/img/menu/Menu_barre_haut.png" alt="Menu barre haut" onerror="this.classList.add('img-missing'); this.alt='Image manquante : /img/menu/Menu_barre_haut.png';" />
                 </div>
                 <ul class="help-list">
                   <li><strong>Hamburger</strong> pour ouvrir le menu</li>
                   <li><strong>Icône d'aide</strong> du menu</li>
                   <li><strong>Total</strong> du nombre de jeux référencés</li>
                   <li>Affiche du <strong>nombre de vignettes par ligne</strong></li>
                   <li>Affichage du <strong>nombre de vignettes simultanément</strong></li>
                   <li><strong>Thème</strong> pour customiser l'apparence</li>
                 </ul>
               </div>

               <div class="help-section">
                 <div class="help-section-title">Filtres / recherche — Menu_barre_haut2.png</div>
                 <div class="help-media">
                   <img src="/img/menu/Menu_barre_haut2.png" alt="Menu barre haut 2" onerror="this.classList.add('img-missing'); this.alt='Image manquante : /img/menu/Menu_barre_haut2.png';" />
                 </div>
                 <ul class="help-list">
                   <li><strong>Barre de recherche</strong> de jeu</li>
                   <li><strong>Tri</strong> des traductions : date, vues, téléchargements…</li>
                   <li><strong>Catégorie</strong></li>
                   <li><strong>Moteur</strong></li>
                   <li><strong>Statut</strong></li>
                   <li><strong>Tags</strong></li>
                   <li><strong>Remise à 0</strong> des choix de recherche</li>
                 </ul>
               </div>
             </div>

             <div class="help-modal-foot">
               <button type="button" class="help-ok">OK</button>
             </div>
           </div>
         `;
         ...
         backdrop.querySelector(".help-ok")?.addEventListener("click", closeHelp);
         document.addEventListener("keydown", (ev) => {
           if (ev.key === "Escape" && !backdrop.classList.contains("hidden")) closeHelp();
         });
