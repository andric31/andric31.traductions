          ...
          <section class="menu-help-section">
            ...
            <div class="menu-help-grid">
              ...
              <dl class="menu-help-dl">
                ...
                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M10 2v6.5L4.5 18a2.5 2.5 0 0 0 2.16 3.75h10.68A2.5 2.5 0 0 0 19.5 18L14 8.5V2"/><path d="M8 2h8"/><path d="M7.5 15h9"/><path d="M9 18h6"/></svg></span><span>Labo</span></dt><dd>Accède au labo et aux outils expérimentaux.</dd></div>
                ...
                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M5 6.5h14a1.5 1.5 0 0 1 1.5 1.5v2a2 2 0 0 0 0 4v2a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 16v-2a2 2 0 0 0 0-4V8A1.5 1.5 0 0 1 5 6.5Z"/><path d="M9 10h6"/><path d="M9 14h6"/></svg></span><span>Ticket</span></dt><dd>Envoyer un ticket privé.</dd></div>

                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M6.25 6.25h11.5A2.25 2.25 0 0 1 20 8.5v6a2.25 2.25 0 0 1-2.25 2.25H11l-4.75 3v-3H6.25A2.25 2.25 0 0 1 4 14.5v-6a2.25 2.25 0 0 1 2.25-2.25Z"/><path d="M8 10.5h8"/><path d="M8 13.5h5.5"/></svg></span><span>Messages</span></dt><dd>Envoyer des messages publics.</dd></div>

                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><rect x="4" y="5" width="16" height="15" rx="2"/><path d="M8 3v4"/><path d="M16 3v4"/><path d="M4 10h16"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 17h.01"/><path d="M12 17h.01"/></svg></span><span>Événements</span></dt><dd>Ouvre la page des événements en cours.</dd></div>
                ...
                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span><span>Mon compte</span></dt><dd>(compte connecté) Accède à la page du compte connecté.</dd></div>

                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M7 3.5h10a1 1 0 0 1 1 1v16.2l-6-3.9-6 3.9V4.5a1 1 0 0 1 1-1z"/><path d="M9 8.5h6"/><path d="M9 12h3.5"/></svg></span><span>Mes jeux</span></dt><dd>(compte connecté) Affiche et gère ta Watchlist, tes jeux likés et tes jeux notés.</dd></div>

                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="5" cy="6" r="1.15" fill="currentColor" stroke="none"/><path d="M9 6h11"/><circle cx="5" cy="12" r="1.15" fill="currentColor" stroke="none"/><path d="M9 12h11"/><circle cx="5" cy="18" r="1.15" fill="currentColor" stroke="none"/><path d="M9 18h11"/></svg></span><span>Liste</span></dt><dd>Nom de la liste des traductions.</dd></div>
                ...
                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M12 2l9 5-9 5-9-5 9-5z"/><path d="M3 12l9 5 9-5"/><path d="M3 17l9 5 9-5"/></svg></span><span>Affichage progressif</span></dt><dd>Nombre de vignettes chargées/affichées (Auto, 50, 100, tout…).</dd></div>

                <div class="menu-help-row"><dt><span class="mh-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M5 7h11"/><path d="M5 12h8"/><path d="M5 17h5"/><path d="M14 4l6 6"/><path d="M16 10l4-4"/></svg></span><span>Rubans Ajout/MAJ</span></dt><dd>Affiche ou masque les rubans diagonaux d’ajout ou MAJ sur les vignettes. <div class="mh-ribbon-demo"><div class="mh-mini-card"><span class="mh-mini-ribbon mh-mini-ribbon--add">AJOUT</span></div><div class="mh-mini-card"><span class="mh-mini-ribbon mh-mini-ribbon--update">MAJ</span></div></div></dd></div>
